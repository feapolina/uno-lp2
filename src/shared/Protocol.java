...
public final class Protocol {
    ...
    // ---------------------------------------------------------
    // 1. CONSTANTES DE REDE
    // ---------------------------------------------------------
    
    public static final String SEPARATOR = ";";

    // Servidor -> cliente
    public static final String MSG_LOBBY = "LOBBY";
    public static final String MSG_SALA_CRIADA = "SALA_CRIADA";
    public static final String SALA_JOIN_SUCCESS = "SALA_JOIN_SUCCESS";
    public static final String MSG_INICIO_PARTIDA = "INICIO_PARTIDA";
    ...
    public static final String MSG_SUA_VEZ = "SUA_VEZ";
    public static final String MSG_ATUALIZACAO = "ATUALIZACAO";
    public static final String MSG_ERRO = "ERRO";
    public static final String MSG_TEMPO_ESGOTADO = "TEMPO_ESGOTADO";
    public static final String MSG_TUDO_BEM = "TUDO_BEM";
    public static final String MSG_COMPROU = "COMPROU";
    public static final String MSG_SAINDO = "SAINDO";
    ...
    public static final String FIM_JOGO_PARTIDA_ENCERRADA = "FIM_JOGO_PARTIDA_ENCERRADA";

    // Cliente -> servidor
    public static final String CMD_CRIAR_SALA = "CRIAR_SALA";
    ...
    public static final String CMD_DORMIU = "DORMIU";
    public static final String CMD_SAIR = "SAIR";

    // ---------------------------------------------------------
    // 2. TRADUÇÃO DAS CARTAS
    // ---------------------------------------------------------
    ...
    public static String[] parseMessage(String rawMessage) {
        ...
        if (trimmed.contains(SEPARATOR)) {
            return trimmed.split(SEPARATOR, -1);
        }

        // Compatibilidade com mensagens legadas separadas por espaço.
        return trimmed.split("\\s+");
    }

    // ---------------------------------------------------------
    // 4. FORMATAÇÃO E LEITURA DE CARTAS
    // ---------------------------------------------------------
